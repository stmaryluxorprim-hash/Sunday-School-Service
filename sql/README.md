...
| 0012 | `0012_member_portal_achievements_events.sql` | بوابة المخدوم: RPC `member_portal_achievements` (كل الإنجازات + حالة حصول المخدوم عليها وتاريخ المنح) + RPC `member_portal_events` (الإعلانات والفعاليات المنشورة من صفحة الخادم) — ربط مباشر بجداول الخادم |
